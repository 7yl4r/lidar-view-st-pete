 ...
 * `scripts/fetch_lidar.py` from USGS 3DEP "FL_Peninsular_Pinellas_2018" (EPT).
 * Points are pre-coloured by ASPRS classification (ground / building / water /
 * vegetation). This is the real source of building shapes — there is no building
 * polygon dataset.
 *
...
export async function addPointCloud(
  ...
  return {
    id: "pointcloud",
    label: "LiDAR point cloud (USGS 3DEP 2018)",
    setVisible: (visible) => {
